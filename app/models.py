...
class JK(UserMixin, db.Model):
    id = db.Column(db.Integer, primary_key=True)  # primary keys are required by SQLAlchemy
    photo = db.Column(db.String(100), default='default_org.png')
    name = db.Column(db.String(100))
...
class AdditionalUK(UserMixin, db.Model):
    id = db.Column(db.Integer, primary_key=True)
    uk_id = db.Column(db.Integer)
    mon = db.Column(db.String(100))
    tue = db.Column(db.String(100))
    wed = db.Column(db.String(100))
    thu = db.Column(db.String(100))
    fri = db.Column(db.String(100))
    sat = db.Column(db.String(100))
    san = db.Column(db.String(100))
    delay = db.Column(db.String(100))
    contact_phones = db.Column(db.String(10000))
    useful_phones = db.Column(db.String(10000))
